  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <button
          type="submit"
          className="font-neues w-full py-4 font-semibold text-white transition-colors bg-brand-blue hover:bg-gray-800 focus:outline-none focus:ring-offset-2 focus:ring focus:ring-gray-200 px-7"
        >
          {isSubmitting ? (
            <svg
